...
<head>
    ...
    <title>footer</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" integrity="sha384-k6RqeWeci5ZR/Lv4MR0sA0FfDOMlENoCZZN6B/9X5vxL3L21JxDp5klCk/LIbX4o" crossorigin="anonymous">
      ...
      <div class="col-md-5 offset-md-1 mb-3">
        <form>
          ...
          <div  class="d-flex flex-column flex-sm-row w-100 gap-2">
            ...
            <button class="btn btn-primary" style="" type="button">Subscribe</button>
          </div>
        </form>
      </div>
    </div>
